...
Zepto(function ($) {
   ...
   */
  var renderCurrentCodeblock = function renderCurrentCodeblock(id) {
  ...
  var highlightCurrentLine = function highlightCurrentLine() {
  ...
  var showTooltip = function showTooltip(elem, msg) {
